...
const IncomeAnalyticsDetail = () => {
  return (
    <div className="bg-background min-h-screen p-12 text-center flex flex-col items-center justify-center font-body">
      ...
      <h1 className="text-4xl font-headline font-extrabold text-on-surface">IncomeAnalyticsDetail</h1>
...
export default IncomeAnalyticsDetail;